                                            ...
                                            <template>
                                                ...
                                                >
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" @click="change_status(user.id)">
        ...
        change_status(user_id) {
            if(user_id !== '' || user_id !== null) {
                axios.put(`/api/users/${user_id}/change_status`)
                    .then(response => {
                        // this.user.status = response;
                        if(response.data.error == false) {
                            // this.user.status = response;
                        }else {
                            // this.user.status = response;
                        }
                        this.users_id.splice(user.status, 1, response.data.new_status)
                        // console.log(response.data.new_status);
                    })
                    .catch(error => {
