...
<!--                                        </tr>-->
                                ...
                                <div class="card-footer clearfix">
                                    <ul class="pagination pagination-sm m-0 float-right">
                                        ...
                                        <li
                                            v-for="(page, index_page) in users.pagination.slice(0,user.pagination.last_page)"
                                            :key="index_page"
                                            class="page-item"
                                            :class="index_page+1 == page.pagination.current_page ? 'active' : ''"
                                        >
                                            <a class="page-link" :href="page">{{ index_page+1 }}</a>
                                        </li>
