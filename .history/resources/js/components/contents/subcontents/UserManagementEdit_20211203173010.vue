                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body m-5">
                                   <div class="alert alert-success alert-dismissible" v-if="success2 == true">
                                        {{ success_msg2 }}
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close" @click="success_dismiss()">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
...
export default {
    ...
    methods: {
        ...
        update()
        {
            // check first if fields has changed
        ...
        updatePass()
        {
            axios.put(`/api/users/${this.$route.params.id}/update_pass`, this.fields)
            .then(response => {
                // this.fields = {};
                this.success_msg2 = response.data.msg;
                this.success = true;
                this.errors = {};
                console.log(response.data);
            })
