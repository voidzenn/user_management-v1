...
<!--                                    <h3 class="card-title">Bordered Table</h3>-->
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" v-show="success == true">
                                        {{ success_msg }}
                                        <button @click="success_dismiss" type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" v-show="fail == true">
                                        {{ fail_msg }}
                                        <button @click="fail_dismiss" type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
