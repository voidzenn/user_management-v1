...
<!--                                        </tr>-->
                                ...
                                <div class="card-footer clearfix">
                                    <ul class="pagination pagination-sm m-0 float-right">
                                        <li class="page-item"
                                            :class="users.pagination.current_page == 1 ? 'disable' : ''"
                                        >
                                        ...
                                        <li class="page-item"
                                            :class="(index_page) == users.pagination.last_page ? 'disabled' : ''"
                                        >
                                            <a class="page-link" href="#"
                                                @click="load_users(users.pagination.current_page+1)"
                                            >next</a>
                                        ...
                                        <li class="page-item"
                                            :class="(index_page+1) == users.pagination.last_page ? 'disabled' : ''"
                                        >
                                            <a class="page-link" href="#"
