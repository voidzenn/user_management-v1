...
<!--                                        </tr>-->
                                ...
                                <div class="card-footer clearfix">
                                    <ul class="pagination pagination-sm m-0 float-right">
                                        ...
                                        <li
                                            v-for="(index_page, page) in users.pagination.last_page"
                                            :key="page.index_page"
                                            class="page-item { page.indexpage == users.pagination.current_page ? 'active' : '' }"
                                            :class=""
                                        >
                                            <a class="page-link" href="#">{{ index_page }}</a>
                                        </li>
