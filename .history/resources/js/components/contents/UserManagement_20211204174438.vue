                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr
                                                ...
                                                :key="user.id"
                                            >
                                                <td>{{ users.data.row_index  }}</td>
                                                <td>{{ user.data.name }}</td>
                                                <td>{{ user.data.email }}</td>
                                                <td>{{ user.data.status }}</td>
                                                <td>{{ user.data.role_name }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <router-link :to="{ name: 'UserManagementEdit', params: { id: user.data.id } }" class="btn btn-primary">Edit</router-link>
                                                        <a name="" id="" class="btn btn-danger ml-1" href="#" role="button" @click="delete_user( user.data.id, index )">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
<!--                                        <tr>-->
...
export default {
    ...
    methods: {
        ...
        load_users() {
            ...
            axios.get(`/api/users/data?page=${page_num}`)
                .then(response => {
