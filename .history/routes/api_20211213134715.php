...
Route::group(['prefix' => 'users'], function(){
    Route::get('/', ['\App\Http\Controllers\Admin\UserController', 'get_user']);
     // sample
    Route::get('/data/{value}', ['\App\Http\Controllers\Admin\UserController', 'get_user_paginate']);
    ...
    Route::put('/{user}/change_status', ['\App\Http\Controllers\Admin\UserController', 'change_status']);
