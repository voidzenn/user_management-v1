...
Route::group(['prefix' => 'users'], function(){
    Route::get('/', ['\App\Http\Controllers\Admin\UserController', 'get_user']);
     // sample
    Route::get('/data', ['\App\Http\Controllers\Admin\UserController', 'get_user_paginate']);
    ...
    Route::put('/{user}/change_status', ['\App\Http\Controllers\Admin\UserControllers', 'change_status']);
